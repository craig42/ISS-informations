...
class HttpService<T:Codable> {
    ...
    func getRequest(path:String, param : Dictionary<String,String>?, callback : @escaping (String) -> Void) {
    ...
    func getIssData(forData: String, param : Dictionary<String,String>?, callback : @escaping (Int)-> Void) {
