...
public class HttpRequest {
    ...
    public static func makeURL(path:String, dict : Dictionary<String,String>?) -> URL {
    ...
    public static func getHttp(url:URL, body:String, callback : @escaping (String, String, Int)-> Void ) {
